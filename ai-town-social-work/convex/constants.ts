...
// This local installation is a long-running social simulation. Keep the engine
// running for a year even when nobody has the browser open.
export const IDLE_WORLD_TIMEOUT = 365 * 24 * 60 * 60 * 1000;
...
// Give distant residents enough time to walk over to a human player.
export const INVITE_TIMEOUT = 3 * 60_000;
...
// Retain memories for a year so long-running experiments keep their history.
export const VACUUM_MAX_AGE = 365 * 24 * 60 * 60 * 1000;
export const DELETE_BATCH_SIZE = 64;

export const HUMAN_IDLE_TOO_LONG = 5 * 60 * 1000;

export const ACTIVITIES = [
  { description: '正在读书', emoji: '📖', duration: 60_000 },
  { description: '正在发呆', emoji: '🤔', duration: 60_000 },
  { description: '正在打理花园', emoji: '🥕', duration: 60_000 },
];
